...
def venn3_ax(ax, labels, names=['A', 'B', 'C'], **options):
    ...
    draw_text(ax, 0.87, 0.25, names[2], colors[2], fontsize=fontsize)
    if legend:
      leg = ax.legend(names, loc='center left', bbox_to_anchor=(1.0, 0.5), fancybox=True)
      leg.get_frame().set_alpha(0.5)
...
def venn6_ax(ax, labels, names=['A', 'B', 'C', 'D', 'E'], **options):
    """
    plots a 6-set Venn diagram
    @type labels: dict[str, str]
    @type names: list[str]
    ...
    # legend
    draw_text(ax, 0.674, 0.824, names[0], colors[0], fontsize=fontsize)
    draw_text(ax, 0.747, 0.751, names[1], colors[1], fontsize=fontsize)
    draw_text(ax, 0.739, 0.396, names[2], colors[2], fontsize=fontsize)
    draw_text(ax, 0.700, 0.247, names[3], colors[3], fontsize=fontsize)
    draw_text(ax, 0.291, 0.255, names[4], colors[4], fontsize=fontsize)
    draw_text(ax, 0.203, 0.484, names[5], colors[5], fontsize=fontsize)
    leg = ax.legend(names, loc='center left', bbox_to_anchor=(1.0, 0.5), fancybox=True)
    leg.get_frame().set_alpha(0.5)
